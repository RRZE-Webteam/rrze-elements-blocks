...
test.describe(() => {
    test('Content Width Limiter Block is present in the block inserter', async ({ page, admin, editor }) => {
        ...
        const blockDiv = page.locator('div.wp-block-rrze-elements-block-contentwidthlimiter');
