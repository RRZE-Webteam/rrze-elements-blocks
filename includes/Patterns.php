    ...
    public function register_dev_patterns()
    {
        ...
        $patterns = [
            [
                ...
                'description' => _x('A testing template for Counter and Iconbox.', 'DEV Template', 'rrze-elements-b'),
                'categories'  => ['dev'],
                'postTypes'   => ['page'],
                'inserter'    => true,
                'keywords'    => [],
            ...
            [
                ...
                'description' => _x('A testing template for Accordions.', 'DEV Template', 'rrze-elements-b'),
                'categories'  => ['dev'],
                'postTypes'   => ['page'],
                'inserter'    => true,
                'keywords'    => [],
    ...
    public function register_fau_custom_wp_block_patterns()
    {
        ...
        $patterns = [
            [
                ...
                'description' => _x('Description for Example Pattern', 'Block pattern description', 'rrze-elements-b'),
            ...
            [
                ...
                'description' => _x('A 3 Column Layout for custom News on Landing pages', 'Block pattern description', 'rrze-elements-b'),
                'categories'  => ['posts'],
            ],
            [
                'file_name'   => 'cta-1',
                ...
                'description' => _x('Call to Action section', 'Block pattern description', 'rrze-elements-b'),
            ...
            [
                ...
                'description' => _x('Two column layout: Image left, text right column.', 'Block pattern description', 'rrze-elements-b'),
                'categories'  => ['portfolio', 'about'],
            ],
            [
                'file_name'   => 'imagefilm',
                ...
                'description' => _x('FAU Imagefilm.', 'Block pattern description', 'rrze-elements-b'),
                'categories'  => ['portfolio', 'about'],
            ],
            [
