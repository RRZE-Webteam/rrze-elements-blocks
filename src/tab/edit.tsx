...
export default function Edit({
  ...
  useEffect(() => {
    console.log("tabs-active-context", context["rrze-elements/tabs-active"]);
    if (context["rrze-elements/tabs-active"] !== blockId) {
        ...
        >
          ...
          <InnerBlocks
            template={[
              [
                "core/paragraph",
                { placeholder: __("Click here and press / to enter content inside your Tab", "rrze-blocks-b") },
              ],
            ]}
          />
        </div>
